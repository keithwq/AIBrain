...
const PRESET_USERS = [
  ...
  ...Array.from({ length: 9 }, (_, index) => ({ nickname: `jy00${index + 1}`, password: '123' })),
  ...Array.from({ length: 9 }, (_, index) => ({ nickname: `jt00${index + 1}`, password: '123' })),
  ...Array.from({ length: 9 }, (_, index) => ({ nickname: `sy00${index + 1}`, password: '123' })),
  ...Array.from({ length: 9 }, (_, index) => ({ nickname: `jk00${index + 1}`, password: '123' })),
];
