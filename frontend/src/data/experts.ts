...
export const EXPERT_DISPLAY: Record<string, ExpertDisplayMeta> = {
  wangdingjun: {
    ...
    alias: '鼎公老师',
    title: '语文教培工作台',
    cardIntro: '老派文气里带着教研手感，帮老师把作文课讲得有章法。',
    shortTitle: '语文教培',
  ...
  zhangxuefeng: {
    ...
    alias: '冰山先生',
    title: '升学就业判断',
    cardIntro: '说话直、重结果，先看现实条件，再给升学和就业路线。',
    shortTitle: '升学就业指导',
  ...
  wangzhigang: {
    ...
    alias: '战略王子',
    title: '战略定位判断',
    cardIntro: '大开大合，先找项目的魂，再落到能撬动资源的抓手。',
    shortTitle: '战略定位',
  ...
  'steve-jobs': {
    ...
    alias: '乔大爷',
    title: '产品取舍判断',
    cardIntro: '挑剔、简洁、审美强，专治功能太多和体验不顺。',
    shortTitle: '产品取舍',
  ...
  luoxiang: {
    ...
    alias: '狂徒张三',
    title: '风险边界判断',
    cardIntro: '像敲着锣鼓讲边界的人，嘴快但逻辑稳，专拆事实、证据和风险。',
    shortTitle: '法律边界',
  ...
  yemaozhong: {
    ...
    alias: '叶将军',
    title: '冲突营销判断',
    cardIntro: '语言短促有冲击力，盯住消费者心里的矛盾和记忆点。',
    shortTitle: '冲突营销',
  ...
  luoyonghao: {
    ...
    alias: '锤子',
    title: '产品表达判断',
    cardIntro: '嘴硬手快，喜欢把卖点一锤定音，接质疑也很利落。',
    shortTitle: '产品表达',
  ...
  fandeng: {
    ...
    alias: '老登',
    title: '知识拆解判断',
    cardIntro: '温和清楚，像一盏会读书的灯，讲结构讲得很明白。',
    shortTitle: '知识拆解',
  ...
  mayun: {
    ...
    alias: '太极老总',
    title: '商业格局判断',
    cardIntro: '爱看长期和组织，常从趋势、生态和人心里找答案。',
    shortTitle: '商业格局',
  ...
  masike: {
    ...
    alias: '极客麻薯',
    title: '第一性原理判断',
    cardIntro: '脑子快、爱实验，像一枚会冒火的火箭，专盯第一性原理。',
    shortTitle: '第一性原理',
  ...
  wentiejun: {
    ...
    alias: '铁军教授',
    title: '结构问题判断',
    cardIntro: '沉稳、结构化，把表面问题放进制度和历史周期里看。',
    shortTitle: '结构问题',
  ...
  xuehuashi: {
    ...
    alias: '磁医薛博',
    title: '磁医学判断',
    cardIntro: '以磁医学为基础理解问题，先看机理、证据和现实边界。',
    shortTitle: '磁医学',
  ...
  zhanqimin: {
    ...
    alias: '肠博士',
    title: '肠道健康判断',
    cardIntro: '严谨克制，专看肠道症状、检查结果和长期调理边界。',
    shortTitle: '肠道健康',
